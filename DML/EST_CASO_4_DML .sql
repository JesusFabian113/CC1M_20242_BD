...
CREATE TABLE IF NOT EXISTS PLANOS_TREINO (
    ...
    CONSTRAINT FK_TREINO FOREIGN KEY (ID_ALUNO) REFERENCES ALUNOS(ID_ALUNO),
    CONSTRAINT FK_PLANO FOREIGN KEY (ID_INSTRUTOR) REFERENCES INSTRUTORES(ID_INSTRUTOR)
);
...
CREATE TABLE IF NOT EXISTS AULAS (
    ...
    CONSTRAINT FK_MODALIDADE FOREIGN KEY (ID_MODALIDADE) REFERENCES MODALIDADES(ID_MODALIDADE),
    CONSTRAINT FK_AULA FOREIGN KEY (ID_INSTRUTOR) REFERENCES INSTRUTORES(ID_INSTRUTOR)
);
...
CREATE TABLE IF NOT EXISTS MATRICULAS (
    ...
    CONSTRAINT FK_MATRICULA FOREIGN KEY (ID_ALUNO) REFERENCES ALUNOS(ID_ALUNO),
    CONSTRAINT FK_ALUNO FOREIGN KEY (ID_MODALIDADE) REFERENCES MODALIDADES(ID_MODALIDADE)
);
...
CREATE TABLE IF NOT EXISTS PAGAMENTOS (
    ...
    CONSTRAINT FK_PAGAMENTO FOREIGN KEY (ID_MATRICULA) REFERENCES MATRICULAS(ID_MATRICULA)
);
