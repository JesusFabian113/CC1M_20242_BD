...
CREATE TABLE IF NOT EXISTS TELEFONES_CLIENTES (
    ...
    CODIGO_CLIENTE INT,
    TELEFONE VARCHAR(15),
    CONSTRAINT FK_FOREIGN KEY (CODIGO_CLIENTE) REFERENCES CLIENTES(CODIGO)
);
...
CREATE TABLE IF NOT EXISTS ENDERECOS_CLIENTES (
    ...
    ESTADO VARCHAR(2),
    CONSTRAINT FK_FOREIGN KEY (CODIGO_CLIENTE) REFERENCES CLIENTES(CODIGO),
    CONSTRAINT FK_FOREIGN KEY (TIPO_ENDERECO) REFERENCES TIPOS_ENDERECO(CODIGO)
);
...
CREATE TABLE IF NOT EXISTS TELEFONES_EMPREGADOS (
    ...
    TELEFONE VARCHAR(15),
 CONSTRAINT FK_FOREIGN KEY (MATRICULA_EMPREGADO) REFERENCES EMPREGADOS(MATRICULA)
);
...
CREATE TABLE IF NOT EXISTS EMPRESAS (
    ...
    PESSOA_CONTATO VARCHAR(100),
    ENDERECO INT,
    CONSTRAINT FK_FOREIGN KEY (ENDERECO) REFERENCES ENDERECOS_EMPRESAS(ID)
);
...
CREATE TABLE TELEFONES_EMPRESAS (
    ...
    TELEFONE VARCHAR(15),
    CONSTRAINT FK_FOREIGN KEY (CNPJ_EMPRESA) REFERENCES EMPRESAS(CNPJ)
);
...
CREATE TABLE IF NOT EXISTS FORNECEDORES (
    ...
    PESSOA_CONTATO VARCHAR(100),
    ENDERECO INT,
    CONSTRAINT FK_FOREIGN KEY (ENDERECO) REFERENCES ENDERECOS_FORNECEDORES(ID)
);
...
CREATE TABLE IF NOT EXISTS ENDERECOS_FORNECEDORES (
    ...
    CIDADE VARCHAR(100),
    ESTADO VARCHAR(2),
    CONSTRAINT FK_FOREIGN KEY (CNPJ_FORNECEDOR) REFERENCES FORNECEDORES(CNPJ),
    CONSTRAINT FK_FOREIGN KEY (TIPO_ENDERECO) REFERENCES TIPOS_ENDERECO(CODIGO)
);
...
CREATE TABLE IF NOT EXISTS COMPONENTES (
    ...
    UNIDADE VARCHAR(10),
    TIPO_COMPONENTE INT,
    CONSTRAINT FK_FOREIGN KEY (TIPO_COMPONENTE) REFERENCES TIPOS_COMPONENTE(CODIGO)
);
...
CREATE TABLE IF NOT EXISTS RE (
    ...
    HORAS_MAO_OBRA INT,
    CODIGO_PRODUTO INT,
    CONSTRAINT FK_FOREIGN KEY (CODIGO_PRODUTO) REFERENCES PRODUTOS(CODIGO)
);
...
CREATE TABLE IF NOT EXISTS RM (
    ...
    DESCRICAO TEXT,
    ID_MAQUINA INT,
    CONSTRAINT FK_FOREIGN KEY (ID_MAQUINA) REFERENCES MAQUINAS(ID)
);
...
CREATE TABLE IF NOT EXISTS RS (
    ...
    CONSTRAINT FK_FOREIGN KEY (CODIGO_COMPONENTE) REFERENCES COMPONENTES(CODIGO)
);
